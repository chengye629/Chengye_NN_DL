...
optimizer2 = nn.optimizer.MomentGD(init_lr=0.002, model=linear_model_neo, mu = 0.9)
optimizer3 = nn.optimizer.MomentumOriginal(init_lr=0.005, model=linear_model_neo)
scheduler = nn.lr_scheduler.MultiStepLR(optimizer=optimizer3, milestones=[800, 2400, 4000], gamma=0.5)
